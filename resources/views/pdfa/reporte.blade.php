		...
		<table cellpadding="0" cellspacing="0" class="table-items" width="100%">
			<thead >
				<tr>
					...
					<th colspan="1" width=""></th>
					<th colspan="1" width="">CANTIDAD</th>
			...
			<tbody class="table table-striped ">
				...
				<tr>
					...
					<td colspan="1" align="center" >{{$item->producto}}</td>
					<td colspan="1" align="center" >{{strtolower($item->ingreso)}}</td>
					<td colspan="1" align="center" >{{strtolower($item->salida)}}</td>
					<td colspan="1" align="center">{{$item->stock}}</td>	
