			...
			<div class="modal-body">
				<div class="table-responsive">
                        <table class="table table-bordered table-striped mt-1">
                            ...
                            <tfoot>
                            	<td class="text-right"><h6 class="text-danger">TOTALES:</h6></td>
                            	<td class="text-center">
                            		@if($details)
                            		<h6 class="text-danger">{{$details->sum('quantity')}}</h6>
                            		@endif
                            	</td>
                            	@if($details)
                            	...
                            	@endforeach
                            	<td></td>
                            	<td class="text-center"><h6 class="text-danger">Bs{{number_format($mytotal,2)}}</h6></td>
                            	@endif
                            </tfoot>
                        </table>
                    </div>
